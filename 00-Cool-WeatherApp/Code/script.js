...
themeColor = document.querySelector("body");
...
function weatherDetails(info) {
  ...
  if (info.cod == "404") {
    ...
    if (id == 800) {
      ...
      themeColor.classList.toggle("clear-sky");
    } else if (id >= 200 && id <= 232) {
      weatherIcon.src = "images/storm.svg";
      themeColor.classList.toggle("storm-sky");
    } else if (id >= 600 && id <= 622) {
      weatherIcon.src = "images/snow.svg";
      themeColor.classList.toggle("snow-sky");
    } else if (id >= 701 && id <= 782) {
      weatherIcon.src = "images/haze.svg";
      themeColor.classList.toggle("haze-sky");
    } else if (id >= 801 && id <= 804) {
      weatherIcon.src = "images/cloud.svg";
      themeColor.classList.toggle("cloud-sky");
    } else if ((id >= 300 && id <= 321) || (id >= 500 && id <= 531)) {
      weatherIcon.src = "images/rain.svg";
      themeColor.classList.toggle("rain-sky");
    }
